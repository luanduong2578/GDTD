...
namespace GDBH
{
    public partial class NG_Ngaygiuongdieutri : Form
    {
        public NG_Ngaygiuongdieutri()
        {
            InitializeComponent();
        ...
        {            
            dataGridView1.DataSource = NG_Ngaygiuongdieutri_DA0.Instance.Load_Ngaygiuong(Datathang);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
               ...
               {
                dataGridView1.DataSource = NG_Ngaygiuongdieutri_DA0.Instance.Load_Ngaygiuong("hsoftdkbd"+maskedTextBox1.Text);
