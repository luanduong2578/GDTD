...
namespace GDBH
{
    public partial class NG_Nhohon24h : Form
    {
        public NG_Nhohon24h()
        {
            InitializeComponent();
        ...
        {
            dataGridView1.DataSource = NG_Nhohon24h_DA0.Instance.Load_Ngaygiuong(Datathang);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
               ...
               {
                   dataGridView1.DataSource = NG_Nhohon24h_DA0.Instance.Load_Ngaygiuong("hsoftdkbd" + maskedTextBox1.Text);
