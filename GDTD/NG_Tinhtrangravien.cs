...
namespace GDBH
{
    public partial class NG_Tinhtrangravien : Form
    {
        public NG_Tinhtrangravien()
        {
            InitializeComponent();
        ...
        {
            dataGridView1.DataSource = NG_Tinhtrangravien_DA0.Instance.Load_Ngaygiuong(Datathang);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
               ...
               {
                   dataGridView1.DataSource = NG_Tinhtrangravien_DA0.Instance.Load_Ngaygiuong("hsoftdkbd" + maskedTextBox1.Text);
