...
namespace GDBH
{
    public partial class BH_BaoGiam : Form
    {
        public BH_BaoGiam()
        {
            InitializeComponent();
            ...
            BH_BaoGiam_DAO.Instance.Insert_TheBhyt(maskedTextBox1.Text);
            BH_BaoGiam_DAO.Instance.Update_Thang_TheBhyt(maskedTextBox1.Text);
        ...
        {
            dataGridView1.DataSource = BH_BaoGiam_DAO.Instance.Load_TheBhyt(Datathang);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                dataGridView1.DataSource = BH_BaoGiam_DAO.Instance.Load_TheBhyt(maskedTextBox1.Text);
            }
            else
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            DataTable dataTable = BH_BaoGiam_DAO.Instance.Load_Tracuu(Load_DA0.Instance.Load_ThangNam_HienTai());
            string id = "";
            ...
            foreach (DataRow r in dataTable.Rows)
            {
                ...
                if(jsontracuudata.GioiTinh == "Nam")
                {
                    PHAI = "0";
                }
                else if (jsontracuudata.GioiTinh == "Nữ")
                {
                    PHAI = "1";
                }
                else 
                ...
                if (jsontracuudata.MaKetQua == "401")
                {
                    ...
                    if (jsontracuudata.MaKetQua != "401")
                    {
                        BH_BaoGiam_DAO.Instance.Update_Tracuu_TheBhyt(jsontracuudata.MaKetQua, ghichu_tc, hoten_tc, NamSinh, PHAI, jsontracuudata.MaThe, jsontracuudata.MaDKBD, jsontracuudata.GtTheTu, jsontracuudata.GtTheDen, hotenkhongdau, id);
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            {
                BH_BaoGiam_DAO.Instance.Update_Tracuu_check(txb_id.Text);
            }
            else
            {
                if (comboBox1.SelectedItem.ToString() != "Không lỗi")
                {
                    BH_BaoGiam_DAO.Instance.Update_Tracuu_Loi(comboBox1.SelectedItem.ToString(), txb_id.Text);
                }
            }
        ...
        {
            dataGridView1.DataSource = BH_BaoGiam_DAO.Instance.Load_Search_MABN(maskedTextBox1.Text, textBox1_MABN.Text);
        }

        private void txb_hoten_TextChanged(object sender, EventArgs e)
        {
            dataGridView1.DataSource = BH_BaoGiam_DAO.Instance.Load_Search_Hoten(maskedTextBox1.Text, textBox3_HOTEN.Text);
        }
