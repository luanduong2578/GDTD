...
namespace GDBH.DAO
{
    class NG_Nhohon24h_DA0
    {

        private static NG_Nhohon24h_DA0 instance;

        public static NG_Nhohon24h_DA0 Instance
        {
            get { if (instance == null) instance = new NG_Nhohon24h_DA0(); return NG_Nhohon24h_DA0.instance; }
            private set { NG_Nhohon24h_DA0.instance = value; }
        }
        private NG_Nhohon24h_DA0() { }
